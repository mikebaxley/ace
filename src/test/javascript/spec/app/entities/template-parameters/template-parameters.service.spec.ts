...
describe('Service Tests', () => {
    ...
    describe('TemplateParameters Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(TemplateParametersService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/template-parameters';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return TemplateParameters', () => {
