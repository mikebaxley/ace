...
describe('Service Tests', () => {
    ...
    describe('WebServiceRequestAudit Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(WebServiceRequestAuditService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/web-service-request-audits';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return WebServiceRequestAudit', () => {
